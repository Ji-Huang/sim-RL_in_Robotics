...
class Config:
    ...
    def get_dart_env_dict():
        dart_env_dict = {
            ...
            'target_mode': "random_push", #"straight_push", #"test"
    ...
    def get_config_dict():
        config_dict = {
            ...
            'image_width':      1800,                     # (*) Gym observation space dimension. See 'iiwa_joint_vel', __init__()
            'image_height':     1080,
            'image_encoding':  'JPG',                   # (*) Encoding of Unity observation image (PNG or JPG)
            'image_quality':   100,                      # (*) Compression of the lossy JPG image
            'image_grayscale': False,                   # (*) Unity observation image as Gray-scale instead of RGB
            'camera_position': [0.0, 1.0, 1.6],        # (*) UNITY
            'camera_rotation': [135.0, 0.0, 180],     # (*)
            ...
            'log_bc_dir': "./agent/logs/bc-2024-03-14-20-40-23-856305/bc_policy",
            'log_dagger_bc_dir': "./agent/logs/bc-dagger-2024-03-09-22-06-55-482528",
            'log_td3_bc': "./agent/logs/td3_bc-2024-03-10-09-47-47-725986",
            ########################################################################
            ...
            'initial_positions': np.deg2rad(np.array([33.69, 51.23, 0.0, -48.99, 0.0, 79.77, 33.69])),                                      # Example options: [0, 0, 0, 0, 0, 0, 0] same as None, [0, 0, 0, -np.pi/2, 0, np.pi/2, 0]
    ...
    def get_localization_config():
        ...
        return localization_config_dict
...
if __name__ == "__main__":
    ...
    xml_file = "./environment/simulator/v0.9/Linux/configuration.xml" # Change the path if needed
